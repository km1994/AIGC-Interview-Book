...
- [分布式训练 Trick 汇总篇](#分布式训练-trick-汇总篇)
  - [一、数据并行 Trick 篇](#一数据并行-trick-篇)
    - [1.1 数据并行 FSDP](#11-数据并行-fsdp)
    - [1.2 数据并行 DDP](#12-数据并行-ddp)
    - [1.3 数据并行 ZeRO](#13-数据并行-zero)
      - [1.3.1 Model state](#131-model-state)
      - [1.3.2 Residual state](#132-residual-state)
      - [1.3.3 offload](#133-offload)
  - [二、模型并行 Trick 篇](#二模型并行-trick-篇)
    - [2.1 tensor-wise parallelism](#21-tensor-wise-parallelism)
    - [2.2 pipeline paralelism](#22-pipeline-paralelism)
    - [2.3 equence parallelism](#23-equence-parallelism)
    - [2.4 layer-wise parallelism](#24-layer-wise-parallelism)
  - [三、MoE Trick 篇](#三moe-trick-篇)
