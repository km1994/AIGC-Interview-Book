...
- [图解分布式训练（四） ——  torch.multiprocessing 详细解析](#图解分布式训练四---torchmultiprocessing-详细解析)
  - [一、torch.multiprocessing 函数介绍一下？](#一torchmultiprocessing-函数介绍一下)
  - [二、torch.multiprocessing 函数如何使用？](#二torchmultiprocessing-函数如何使用)
  - [三、介绍一下 共享CUDA张量？](#三介绍一下-共享cuda张量)
  - [四、介绍一下 共享策略？](#四介绍一下-共享策略)
    - [4.1 介绍一下文件描述符 -file\_descripor？](#41-介绍一下文件描述符--file_descripor)
    - [4.2 文件系统 -file\_system](#42-文件系统--file_system)
  - [五、torch.multiprocessing 函数使用](#五torchmultiprocessing-函数使用)
  - [参考](#参考)
...
1. Multiprocessing包 - torch.multiprocessing: https://ptorch.com/docs/1/torch-multiprocessing
